...
Verilog is the main logic design language for [lowRISC](https://lowrisc.org) Comportable IP.
...
This guide defines the Comportable(compatible과 portable의 합성어) style for Verilog. The goals are to:
